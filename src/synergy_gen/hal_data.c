...
#if !defined(SSP_SUPPRESS_ISR_g_timer2) && !defined(SSP_SUPPRESS_ISR_GPT0)
...
{ .mode = TIMER_MODE_PWM, .period = 100, .unit = TIMER_UNIT_FREQUENCY_HZ, .duty_cycle = 50, .duty_cycle_unit =
  ...
  .channel = 0, .autostart = true, .p_callback = NULL, .p_context = &g_timer2, .p_extend = &g_timer2_extend, .irq_ipl =
          (BSP_IRQ_DISABLED), };
